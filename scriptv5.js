...
$('#trigger1').click(() => {
    ...
    if (reward == '<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878becd78b976e54c47aeb_small-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>') {
        ...
        $('#prize-block-1').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
        ...
        setTimeout(function(){
            ...
            $('#prize-block-2').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
            $('#prize-block-3').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
        ...
        $('#prize-block-1').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
        $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
        ...
        setTimeout(function(){
            ...
            $("#prize-3").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878510a560bd3648acce1d_big-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-2').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
            $('#prize-block-3').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
            $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
        ...
        $('#prize-block-1').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
        $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );

        setTimeout(function(){
            $("#prize-2").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878a0293e86767a8ff9926_medium-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $("#prize-3").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878becd78b976e54c47aeb_small-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-2').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
            $('#prize-block-3').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
            $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
...
$('#trigger2').click(() => {
    ...
    if (reward == '<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878becd78b976e54c47aeb_small-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>') {
        ...
        $('#prize-block-2').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
        $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
        ...
        setTimeout(function(){
            ...
            $("#prize-3").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878510a560bd3648acce1d_big-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-1').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
            $('#prize-block-3').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
            $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
        ...
        $('#prize-block-2').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
        $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
        ...
        setTimeout(function(){
            ...
            $("#prize-3").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878510a560bd3648acce1d_big-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-1').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
            $('#prize-block-3').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
            $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
        ...
        $('#prize-block-2').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
        $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
...
$('#trigger3').click(() => {
    ...
    if (reward == '<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878becd78b976e54c47aeb_small-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>') {
        ...
        $('#prize-block-3').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
        $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );

        setTimeout(function(){
            $("#prize-2").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878a0293e86767a8ff9926_medium-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $("#prize-1").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878510a560bd3648acce1d_big-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-2').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
            $('#prize-block-1').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
            $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
        ...
        $('#prize-block-3').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
        $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
        ...
        $('#prize-block-3').append('<div class="text-block-3">você ganhou<br><span class="text-span">R$'+Math.round(bigReward)+'</span></div>');
        $('#prize-block-3').delay(1000).animate({opacity: '1'}, 500 );
        ...
        setTimeout(function(){
            ...
            $("#prize-1").append('<lottie-player src="https://uploads-ssl.webflow.com/628239cfa6d9f0b6479c6b41/62878becd78b976e54c47aeb_small-prize.json"  background="transparent"  speed="1"  style="width: 100px; height: 270px;"  autoplay></lottie-player>');
            $('#prize-block-2').append('<div class="text-block-3">Indique<br>amigos<br><span class="text-span">R$'+Math.round(mediumReward)+'</span></div>');
            $('#prize-block-1').append('<div class="text-block-3">Faça<br>Depósitos<br><span class="text-span">R$'+Math.round(smallReward)+'</span></div>');
            $('#prize-block-2').delay(1000).animate({opacity: '1'}, 500 );
            $('#prize-block-1').delay(1000).animate({opacity: '1'}, 500 );
        },2000);
